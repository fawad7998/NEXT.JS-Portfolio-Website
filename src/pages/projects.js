...
const Projects = () => {
  return (
    <>
      <Head>
        <title>Fawad | Projects</title>
        <meta name="description" content="Fawad | Projects" />
        <meta property="og:title" content="Fawad | Projects" />
        <meta property="og:description" content="Fawad | Projects" />
      </Head>
      <TransitionEffect />
